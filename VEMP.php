...
<head>
  ...
  $sql = "SELECT s.sid,s.staffname,s.staffphone,s.staffadd,b.branchcode,b.branchname,s.emptype FROM stafftable as s,branchtable as b where s.branchcode=b.branchcode";
